  ...
  <div class="flex items-center min-h-screen">
    <div class="container mx-auto">
      <div class="max-w-md mx-auto my-6 bg-white p-5 rounded-md">
        <div class="m-auto mb-8" v-if="emailSendResponse.ok !== null">
          <div class="bg-white rounded-lg border-gray-300 border p-3 shadow-md mb-3" v-if="emailSendResponse.ok" data-aos="fade-right"
               data-aos-offset="300"
        ...
        <div class="text-center mt-4">
          <h1 class="my-3 text-3xl font-semibold text-gray-700 dark:text-gray-200" data-aos="fade-up">Contact Me</h1>
          <p class="text-gray-400 dark:text-gray-400" data-aos="fade-up">Fill up the form below to send me a message.</p>

        </div>
        <div class="m-7">
          <form method="POST" id="form" @submit.prevent="sendEmail">
            <div class="mb-6" data-aos="fade-up-right"  data-aos-once="true" >
            ...
            <div class="mb-6" data-aos="fade-up-left"  data-aos-once="true" >
              <label for="email" class="block mb-2 text-left text-sm text-gray-600 dark:text-gray-400">Email Address</label>
              <input type="email" name="email" id="email" v-model="email" placeholder="you@gmail.com" required class="w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-gray-700 dark:text-white dark:placeholder-gray-500 dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500" />
            </div>
            <div class="mb-6" data-aos="fade-up-right"  data-aos-once="true" >
            ...
            <div class="block mx-auto text-center g-recaptcha my-3 mx-auto" data-aos="fade-up-right"  data-aos-once="true" :data-sitekey="siteKey" style="transform:scale(0.89);transform-origin:0 0;"> </div>
            <div class="mb-6" data-aos="fade-up"  data-aos-once="true">
              <input type="submit" @click="scrollToTop()" class="w-full mx-2 px-3 py-3 text-white bg-indigo-500 rounded-md focus:bg-indigo-600 focus:outline-none" value="Send Message">
            </div>
