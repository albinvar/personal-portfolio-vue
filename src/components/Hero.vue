<template>
 <section class="bg-white py-3">
		 	<div class="flex items-end justify-center my-6">
                    <img class="h-56 w-56 rounded-full shadow-lg animate__animated animate__jackInTheBox" src="../assets/me.webp" />
             </div>
            ...
            <div class="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between" data-aos="fade-down">
                ...
                <a class="link" href="https://mobile.twitter.com/AlbinVa73331234" data-tippy-content="@AlbinVa73331234">
                    <svg class="h-6 fill-current text-gray-600 hover:text-teal-700" role="img" viewBox="0 0 24 24"
                ...
                <a class="link" href="https://github.com/albinvar" data-tippy-content="@albinvar">
                    <svg class="h-6 fill-current text-gray-600 hover:text-teal-700" role="img" viewBox="0 0 24 24"
                ...
                <a class="link" href="https://unsplash.com/@albinvar" data-tippy-content="@albinvar">
                    <svg class="h-6 fill-current text-gray-600 hover:text-teal-700" role="img" viewBox="0 0 24 24"
                ...
                <a class="link" href="https://dribbble.com/albinvar" data-tippy-content="@albinvar">
                    <svg class="h-6 fill-current text-gray-600 hover:text-teal-700" role="img" viewBox="0 0 24 24"
                ...
                <a class="link" href="https://www.instagram.com/android_exploiter/"
                ...
                <a class="link" href="#" data-tippy-content="@unavailable">
                    <svg class="h-6 fill-current text-gray-600 hover:text-teal-700" role="img"
