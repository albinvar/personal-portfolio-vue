...
<div class="max-w-md m-6 bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl transform hover:scale-95 transition duration-500 hover:bg-gray-100">
    <div class="">
    <div class="">
      <img class="h-40 w-full object-cover" src="https://cdn.pixabay.com/photo/2020/07/21/16/24/landscape-5426755_640.jpg" alt="Man looking at item at a store">
    </div>
    <div class="p-4">
...
<div class="max-w-md m-6 bg-white rounded-xl shadow-md overflow-hidden transform hover:scale-95 transition duration-500 hover:bg-gray-100">
    <div class="">
  ...
  <div class="max-w-md m-6 bg-white rounded-xl shadow-md overflow-hidden transform hover:scale-95 transition duration-500 hover:bg-gray-100">
    <div class="">
      <div class="animate-pulse space-8 bg-gray-300 h-40">
        <span class=""></span>
      </div>
      <div class="p-4">
        <div class="my-4 mx-20 animate-pulse space-y-4 h-4 rounded bg-gray-200 title-font font-medium"></div>
